...
RCT_EXPORT_VIEW_PROPERTY(allowHeaderRefresh, BOOL)
RCT_EXPORT_VIEW_PROPERTY(allowFootererRefresh, BOOL)
...
RCT_EXPORT_METHOD(endRefresh:(nonnull NSNumber *)reactTag isHeader:( BOOL)isHeader)
{
